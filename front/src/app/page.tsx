      ...
      <div className="absolute inset-0 z-10 w-full h-full pointer-events-none">
        {floatingCards.map((card) => (
          <div
            ...
            style={{
              top: isMobile && card.mobileStyle ? card.mobileStyle.top : card.top,
              left: isMobile && card.mobileStyle ? card.mobileStyle.left : card.left,
              right: isMobile && card.mobileStyle ? card.mobileStyle.right : card.right,
