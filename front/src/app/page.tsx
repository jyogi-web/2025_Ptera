...
const floatingCards = [
  ...
  { id: 1, src: "/assets/student_card_1.png", top: "10%", left: "5%", animation: "animate-float-slow", rotate: "-6deg", scale: "1.0", delay: "0s", hiddenOnMobile: false, mobileStyle: { top: "5%", left: "-5%", scale: "0.8" } },
  { id: 2, src: "/assets/student_card_2.png", top: "15%", right: "8%", animation: "animate-float-medium", rotate: "8deg", scale: "0.9", delay: "1s", hiddenOnMobile: false, mobileStyle: { top: "8%", right: "-5%", scale: "0.75" } },
  { id: 3, src: "/assets/student_card_3.png", top: "70%", left: "8%", animation: "animate-float-fast", rotate: "-12deg", scale: "1.1", delay: "2s", hiddenOnMobile: true },
  { id: 4, src: "/assets/student_card_1.png", top: "55%", right: "8%", animation: "animate-float-slow", rotate: "5deg", scale: "0.8", delay: "3s", hiddenOnMobile: true },
  { id: 5, src: "/assets/student_card_2.png", top: "35%", left: "25%", animation: "animate-float-medium", rotate: "3deg", scale: "0.6", opacity: 0.6, delay: "4s", hiddenOnMobile: true },
  { id: 6, src: "/assets/student_card_3.png", top: "40%", right: "30%", animation: "animate-float-fast", rotate: "-4deg", scale: "0.6", opacity: 0.6, delay: "5s", hiddenOnMobile: true },

  // Mobile specific filler cards (smaller, blurred, background)
  { id: 7, src: "/assets/student_card_3.png", top: "60%", left: "-10%", animation: "animate-float-slow", rotate: "15deg", scale: "0.6", opacity: 0.4, delay: "0.5s", hiddenOnMobile: false, onlyMobile: true },
  { id: 8, src: "/assets/student_card_1.png", top: "75%", right: "-10%", animation: "animate-float-medium", rotate: "-10deg", scale: "0.6", opacity: 0.4, delay: "1.5s", hiddenOnMobile: false, onlyMobile: true },
];
...
export default function Home() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-[#050510] text-white">
      ...
      <div className="absolute inset-0 z-10 w-full h-full pointer-events-none">
        {floatingCards.map((card) => (
          <div
            ...
            style={{
              top: card.mobileStyle && typeof window !== 'undefined' && window.innerWidth < 768 ? card.mobileStyle.top : card.top,
              left: card.mobileStyle && typeof window !== 'undefined' && window.innerWidth < 768 ? card.mobileStyle.left : card.left,
              right: card.mobileStyle && typeof window !== 'undefined' && window.innerWidth < 768 ? card.mobileStyle.right : card.right,
              transform: `rotate(${card.rotate}) scale(${card.mobileStyle && typeof window !== 'undefined' && window.innerWidth < 768 ? card.mobileStyle.scale : card.scale})`,
      ...
      {/* Main Content */}
      <main className={`relative z-20 flex flex-col items-center text-center transition-opacity duration-1000 ${showContent ? "opacity-100" : "opacity-0"} px-4 w-full max-w-4xl`}>
        ...
        <h1 className="relative mb-6 text-5xl sm:text-6xl md:text-8xl font-black tracking-widest select-none flex flex-col md:block items-center drop-shadow-[0_0_15px_rgba(255,0,255,0.5)]">
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-pink-400 to-purple-600 text-glow-pink mr-0 md:mr-4 block md:inline mb-2 md:mb-0">さく</span>
          <span className="text-transparent bg-clip-text bg-gradient-to-b from-pink-400 to-purple-600 text-glow-pink block md:inline mb-2 md:mb-0">さく</span>
        ...
        <p className="mb-16 text-sm sm:text-lg md:text-2xl font-bold tracking-wider text-cyan-50 drop-shadow-md px-2 max-w-lg mx-auto leading-relaxed">
          4年間の青春（データ）、<br className="block md:hidden" />回収します。
        </p>
