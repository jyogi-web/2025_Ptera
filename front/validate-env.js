...
try {
    ...
    if (rawValue.startsWith("'") && rawValue.endsWith("'")) {
        console.log("⚠️ Value appears to be wrapped in single quotes. This might be okay if processed by dotenv, but let's check content.");
    }
    ...
    try {
        ...
        if (rawValue.includes("'")) {
            console.log('💡 Hint: The string contains single quotes (\'). JSON standard requires double quotes (") for keys and string values.');
        }
        if (!rawValue.includes('"')) {
            console.log('💡 Hint: The string does not contain any double quotes. Valid JSON must use double quotes.');
        }
